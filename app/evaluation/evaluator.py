...
class VoiceIQEvaluator:
    ...
    def _asr_proxy(asr_segments: list[dict], transcript: str) -> dict[str, Any]:
        ...
        return {
            "duration_sec": round(duration, 3),  # type: ignore
            "total_words": total_words,
            "num_segments": num_segments,
            "words_per_sec": round(words_per_sec, 3),  # type: ignore
            "avg_segment_sec": round(avg_seg_sec, 3),  # type: ignore
            "repetition_ratio": round(rep_ratio, 3),  # type: ignore
        }
    ...
    def _diar_proxy(diar_segments: list[dict]) -> dict[str, Any]:
        ...
        return {
            ...
            "avg_segment_sec": round(avg_len, 3),  # type: ignore
    ...
    def _alignment_health(asr_segments: list[dict], speaker_segments: list[dict]) -> dict[str, Any]:
        ...
        return {
            ...
            "coverage": round(coverage, 3),  # type: ignore
    ...
    def _summary_proxy(transcript: str, summary: str | None) -> dict[str, Any]:
        ...
        return {
            ...
            "compression_ratio": round(compression, 4),  # type: ignore
        }
